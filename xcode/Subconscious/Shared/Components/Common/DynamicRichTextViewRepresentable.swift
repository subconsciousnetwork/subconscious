//
//  DynamicRichTextViewRepresentable.swift
//  DynamicRichTextViewRepresentable
//
//  Created by Gordon Brander on 8/26/21.
//

import SwiftUI

/// A textview that grows to the height of its content
struct DynamicRichTextViewRepresentable: UIViewRepresentable {
    ...
    class Coordinator: NSObject, UITextViewDelegate {
        var representable: DynamicRichTextViewRepresentable

        init(_ representable: DynamicRichTextViewRepresentable) {
    ...
    func makeCoordinator() -> DynamicRichTextViewRepresentable.Coordinator {
        Coordinator(self)
    }
...
struct DynamicRichTextViewRepresentable_Preview: PreviewProvider {
    static var previews: some View {
        GeometryReader { geometry in
            VStack {
                DynamicRichTextViewRepresentable(
                    attributedText:
                        .constant(NSAttributedString(string: "Text")),

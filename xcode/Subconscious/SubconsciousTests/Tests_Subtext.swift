...
class Tests_Subtext: XCTestCase {
    ...
    func testHeaders() throws {
        ...
        Title: Husker knights
        
        Body text
        More body text
        """
        let dom = Subtext.parse(markup: markup)
        XCTAssertEqual(dom.headers.count, 2)
        XCTAssertEqual(dom.headers[0].name, "content-type")
        XCTAssertEqual(dom.headers[0].value, "text/subtext")
        XCTAssertEqual(dom.headers[1].name, "title")
        XCTAssertEqual(dom.headers[1].value, "Husker knights")
    ...
    func testMissingHeaders() throws {
        ...
        """
        let dom = Subtext.parse(markup: markup)
        XCTAssertEqual(dom.headers.count, 0)
    ...
    func testBrokenFirstHeader() throws {
        let markup = """
        Content Type: Broken
        Body text
        More body text
        ...
        XCTAssertEqual(text, "Content Type: Broken")
    }
}
